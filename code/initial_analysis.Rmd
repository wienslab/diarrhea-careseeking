...
# set colors
#TODO: there is still some confounding between timing of care seeking and GE, which may be why the post-stratified estimates don't seem to match the beta coefficients; is it okay to assume that the stratified estimates are right and the beta coeffients are off? or better to just remove this and stick with univariate analyses? 
#TODO: test this by running the post-strat on the univariate version of the case_cat model
