...
NB: Code below has bugs; n_surveyed and prop_sought_care are not calculated correctly (which is why we are seeking proportions > 1)
Probably best to rewrite this
