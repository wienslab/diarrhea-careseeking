...
```{r run univariate meta-regressions, message = TRUE}
...
### Table S1. Univariate analyses of factors associated with variation in care seeking
...
### Table S2. Tests for potential confounding with severe diarrhea case definition
...
### Table S3. Sub-analyses of study describing an outbreak and recall period
...
vc_coef %>%
  flextable() %>%
  save_as_docx(path = here::here('code/tables/tableS3-1.docx'))
```
...
dia_coef %>%
  flextable() %>%
  save_as_docx(path = here::here('code/tables/tableS3-2.docx'))
```
...
### Figure S11. Forest plot of care seeking for general diarrhea in LMICs
...
### Figure S12. Forest plot of care seeking for for severe diarrhea or cholera in LMICs
...
### Figure S13. Forest plot of care seeking for gastroenteritis or other etiologies in LMICs
