...
3.  Multivariate model(s) adjusted for factors identified as significant but not confounding/collinear in univariate models.

*NB*: Here our observations represent data aggregated to study_id, country, and potential covariate stratifications. For studies with multiple choice questions, we take the maximum sample size and number seeking care for studies where there were multiple categories of "hospital/clinic" as possible answers.
...
### Figure S11. Forest plot of care seeking at a hospital or clinic by individuals already at a clinic in LMICs

```{r figS11, fig.width = 10, fig.height = 3}
...
### Figure S12. Forest plot of care seeking at a hospital or clinic in HICs

```{r figS12, fig.width = 10, fig.height = 7}
...
Odds that an individual seeks care for themselves or their child overall or by alternate case definitions, adjusting for timing of care seeking.
...
### Figure S13. Forest plot of care seeking for general diarrhea in LMICs

```{r figS13, fig.width = 8, fig.height = 26}
...
### Figure S14. Forest plot of care seeking for for severe diarrhea or cholera in LMICs

```{r figS14, fig.width = 8, fig.height = 5.25}
...
### Figure S15. Forest plot of care seeking for gastroenteritis or other etiologies in LMICs

```{r figS15, fig.width = 8, fig.height = 3.5}
