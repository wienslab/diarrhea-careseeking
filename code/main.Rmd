...
```{r figS8, fig.width = 8, fig.height = 6.5}
# overall proportion seeking care
fS8a <- plot_seekprop(sr_clinic_sources %>% filter(time_care == 'First source'), 
                      'location_type', num_colors=10, palette = 'Spectral') +
  theme(legend.position = 'none') +
  scale_color_manual(values=brewer.pal(n=9, name='Dark2')) +
  ggtitle('First source of care')

# first source of care
fS8b <- plot_seekprop(sr_clinic_sources %>% 
                        filter(time_care == 'Prior to current visit', location_type != 'Any care outside home'), 
                     'location_type', num_colors=10, palette = 'Spectral') +
  theme(legend.position = 'none') +
  scale_color_manual(values=brewer.pal(n=9, name='Dark2')) +
