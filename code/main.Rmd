...
### Care seeking in the unadjusted data
...
```{r, fig.width = 10}
floc1 <- plot_seekprop(sr_dat_sources, 'location_type', 
...
floc2a <- plot_seekprop(sr_dat_sources, 'location_type', 
                       num_colors=10, palette = 'Spectral') +
  theme_dark() +
  theme(legend.position = 'none')
...
```{r, fig.width = 8, fig.height = 11}
floc2b <- plot_seekprop(sr_dat_sources, 'case_cat', num_colors=3) +
...
```{r, fig.width = 10, fig.height = 10}
floc3a <- plot_seekprop(sr_dat_sources, 'location_type', 
                       num_colors=10, palette = 'Spectral') +
  theme_dark() +
  theme(legend.position = 'none')
...
```{r, fig.width = 8, fig.height = 11}
floc3b <- plot_seekprop(sr_dat_sources, 'income_group', num_colors=3) +
  facet_wrap('location_type', ncol = 2)
...
```{r, fig.width = 10, fig.height = 10}
floc4a <- plot_seekprop(sr_dat_sources, 'location_type', 
                       num_colors=10, palette = 'Spectral') +
  theme_dark() +
  theme(legend.position = 'none')
...
```{r, fig.width = 8, fig.height = 11}
floc4b <- plot_seekprop(sr_dat_sources, 'time_care', num_colors=4) +
  facet_wrap('location_type', ncol = 2)
...
```{r, fig.width = 10, fig.height = 10}
floc5a <- plot_seekprop(sr_dat_sources, 'location_type', 
                       num_colors=10, palette = 'Spectral') +
  theme_dark() +
  theme(legend.position = 'none')
...
```{r, fig.width = 8, fig.height = 11}
floc5b <- plot_seekprop(sr_dat_sources, 'self_or_child', num_colors=3) +
  facet_wrap('location_type', ncol = 2)
...
cs_plot <- cs[1:5,] %>% 
  mutate(facet = c('Unadjusted', 
                   rep('Stratum: Caregiver; testing case definition', 3),
                   rep('Stratum: Caregiver', 1))) 
