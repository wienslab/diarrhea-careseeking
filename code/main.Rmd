...
*NB / TODO*:
* Before building models 2 and 3, we need to run univariate analyses. Results below just represent unadjusted, model 1 results for now.
* Also need to examine why proportion seeking care is so sensitive to priors. May need to reconstruct this model as well.
* Structure this code so it requires less copy/paste (will get cumbersome with stratifications and sub-analyses).
