...
```{r figS6, fig.width = 10, fig.height = 9}
...
```{r figS7, fig.width = 10, fig.height = 9}
...
```{r figS8, fig.width = 10, fig.height = 9}
...
vc_coef %>%
  flextable() %>%
  save_as_docx(path = here::here('code/tables/tableS6-1.docx'))
```
...
dia_coef %>%
  flextable() %>%
  save_as_docx(path = here::here('code/tables/tableS6-2.docx'))
```
...
or_table(c2) %>%
  flextable() %>%
  save_as_docx(path = here::here('code/tables/table2.docx'))
```
...
### Figure S11. Forest plot for stratified meta-analysis of whether people sought care at a hospital or clinic for general diarrhea

```{r figS11, fig.width = 8, fig.height = 26}
...
### Figure S12. Forest plot for stratified meta-analysis of whether people sought care at a hospital or clinic for severe diarrhea or cholera

```{r figS12, fig.width = 8, fig.height = 5.25}
...
### Figure S13. Forest plot for stratified meta-analysis of whether people sought care at a hospital or clinic for gastroenteritis or other etiologist

```{r figS13, fig.width = 8, fig.height = 3.5}
